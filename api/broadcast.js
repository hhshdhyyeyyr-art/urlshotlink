...
export default async function handler(req, res) {
    ...
    // Vercel Environment Variables se BOT_TOKEN aayega
    ...
    // Aapka live vercel URL as default fallback
    const finalUrl = mini_app_url || "https://urlshotlink.vercel.app/";
    ...
    for (const chat_id of chat_ids) {
        try {
            ...
            // Telegram API Rate limit bachane ke liye delay (Strictly Recommended: 35ms)
